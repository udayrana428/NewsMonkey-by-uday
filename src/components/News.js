        ...
        return (
            <>
                ...
                {/* <div className="pre-next d-flex justify-content-around">
                    <button disabled={this.state.page <= 1} className="prev-btn btn btn-dark" onClick={this.handleprev}>&laquo; Previous</button>
                    <button disabled={this.state.page + 2 > Math.ceil(this.state.totalResults / 10)} className="next-btn btn btn-dark" onClick={this.handlenext}>Next &raquo; </button>
                </div> */}
            </>
        )
    }
